                          ...
                          {service.packages.map((pkg, pIdx) => (
                            ...
                            >
                              ...
                              <div className="mt-auto relative z-10">
                                <div className={`w-full hover:scale-[1.02] cursor-pointer py-4 text-center rounded-xl font-bold uppercase text-xs tracking-widest transition-all ${pkg.highlight ? 'bg-accent text-background' : 'bg-white/5 text-text border border-white/10 hover:bg-white/10'
                                  }`}>
