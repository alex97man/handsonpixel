   ...
   return (
      <div className="w-full relative break-words text-text pb-24 min-h-screen">
         ...
         <section className="px-6 md:px-8 max-w-5xl mx-auto mb-20 md:mb-32">
            ...
            >
               <img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=2070&q=80" alt="E-commerce Platforms Comparison" className="w-full h-full object-cover" />
            </motion.div>
         </section>
