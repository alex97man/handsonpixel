        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-1">
            ...
            <p className="text-muted text-sm leading-relaxed">
              Organizare conținut, structurare cuprins și design coperți pentru un raport de cercetare de 150+ pagini.
            </p>
          </div>
          <div className="md:col-span-1">
            ...
            <ul className="text-muted text-sm leading-relaxed space-y-2">
              <li>Design Revistă / Raport</li>
            </ul>
          </div>
          <div className="md:col-span-1">
            <h3 className="text-lg font-bold uppercase tracking-widest text-accent mb-4">Tool</h3>
            <p className="text-muted text-sm leading-relaxed">Adobe InDesign</p>
          </div>
        </div>
      </section>
