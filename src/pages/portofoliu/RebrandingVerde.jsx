...
import logoRevealGif from '../../assets/logo_reveal_2.gif';
import rebranding1 from '../../assets/rebranding1.jpg';
import rebranding2 from '../../assets/rebranding2.jpg';
    ...
    <div className="w-full relative break-words text-text pb-24">
      ...
      <section className="pt-40 md:pt-48 pb-16 px-6 md:px-8 max-w-5xl mx-auto relative z-10 w-full">
        ...
        <motion.div initial="hidden" animate="visible" variants={{ hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.15 } } }}>
          ...
          <motion.p variants={fadeUpVariants} className="text-xl md:text-2xl text-muted max-w-2xl font-medium leading-relaxed">
             O nouă identitate vizuală pentru un festival ce îmbină sustenabilitatea cu arta teatrală.
          </motion.p>
        </motion.div>
      </section>
      ...
      <section ref={targetRef} className="px-6 md:px-8 max-w-5xl mx-auto mb-20 relative">
        ...
        >
          <motion.img 
             style={{ y, scale: 1.3 }}
             src="https://images.unsplash.com/photo-1543733216-796835de38bb?q=80&w=2070&auto=format&fit=crop" alt="Verde la Teatru Rebranding" className="w-full h-full object-cover" />
        </motion.div>
      </section>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="md:col-span-1">
               ...
               <p className="text-muted text-sm leading-relaxed">
                  Rebranding-ul a vizat modernizarea logo-ului și a elementelor vizuale secundare pentru a reflecta valorile ecologice.
               </p>
            </div>
            <div className="md:col-span-1">
               ...
               <ul className="text-muted text-sm leading-relaxed space-y-2">
                  ...
                  <li>Design Materiale Promo</li>
               </ul>
            </div>
            <div className="md:col-span-1">
               <h3 className="text-lg font-bold uppercase tracking-widest text-accent mb-4">Client</h3>
               <p className="text-muted text-sm leading-relaxed">Verde la Teatru</p>
            </div>
         </div>
      </section>
      ...
      <section className="px-6 md:px-8 max-w-5xl mx-auto mb-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 40 }} viewport={{ once: true }} className="rounded-[2.5rem] overflow-hidden aspect-[4/5] border border-white/10 relative">
            <img src={logoRevealGif} alt="Logo Reveal Animation" className="w-full h-full object-cover" />
          </motion.div>
          ...
          <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 40 }} viewport={{ once: true }} className="rounded-[2.5rem] overflow-hidden aspect-[4/5] border border-white/10">
            <img src={rebranding1} alt="Brand Element 1" className="w-full h-full object-cover" />
          </motion.div>

          {/* Image 2 Card */}
          <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 40 }} viewport={{ once: true }} className="rounded-[2.5rem] overflow-hidden aspect-[4/5] border border-white/10">
            <img src={rebranding2} alt="Brand Element 2" className="w-full h-full object-cover" />
          </motion.div>
        </div>
      </section>
