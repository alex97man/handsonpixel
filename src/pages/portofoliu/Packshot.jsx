...
export default function Packshot() {
  ...
  return (
    <div className="w-full relative break-words text-text pb-24">
      <SEO 
        title="Packshot | Product Photography"
        description="Fotografie packshot profesională: Studiu vizual pentru produse cu suprafețe albe și reflexii complexe (irigator bucal)."
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-1">
            ...
            <p className="text-muted text-sm leading-relaxed">
              Proiect fictiv. Fotografie packshot și editorială pentru un irigator bucal — produs cu suprafețe albe și reflexii complexe.
            </p>
          </div>
          <div className="md:col-span-1">
